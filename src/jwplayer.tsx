...
function createOnEventHandler(
  props: JWPlayerProps,
): (name: string, optReturn?: any) => void {
...
const JWPlayer = React.forwardRef<JWPlayerRef, JWPlayerProps>(
  (props, forwardedRef) => {
    ...
    const onHandlerRef = useRef<
      ((name: string, optReturn?: any) => void) | null
    >(null);
    ...
    useImperativeHandle(forwardedRef, () => ({
      ...
      set onHandler(value: ((name: string, optReturn?: any) => void) | null) {
